...
namespace MMI
{
    ...
    public class ConfigurationData
    {
        ...
        private static string filePath = Application.StartupPath + "\\MMI_ConfigData.ini";//获取INI文件路径
        private static string sectionVOBC = "local"; //INI文件名
        private static string sectionZC = "remote"; //INI文件名  
        ...
        public static void ReadConfigData()
        {
            try
            {
                ...
                {
                    MessageBox.Show("未找到配置文件，MMI将不能运行！");
                    return;
                }
                else
                {
